...
export default function HobbiesOrbit() {
  return (
    ...
    >
      <div className="relative z-10 px-[5vw] max-w-[1560px] mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {hobbies.map((h) => (
            <div
              key={h.title}
              className="hobby-card group relative rounded-2xl border border-line backdrop-blur-sm px-8 py-7 flex flex-col items-center text-center gap-6 transition-all duration-500 hover:border-[#64FFDA]/50 hover:-translate-y-2 hover:shadow-[0_25px_55px_-18px_rgba(100,255,218,0.35)]"
            ...
            >
              ...
              <div className="relative z-10 w-[58px] h-[58px] rounded-full bg-[#16283f] border border-[#64FFDA]/40 flex flex-col items-center justify-center gap-0.5 shadow-[0_0_22px_rgba(100,255,218,0.25)] transition-transform duration-300 group-hover:scale-105">
              ...
              <div className="relative z-10 grid grid-cols-3 gap-2.5 w-full">
                {h.items.map((item) => (
                  <div
                    key={item.label}
                    className="flex items-center justify-start gap-2 rounded-full pl-2 pr-3.5 py-1.5 border backdrop-blur-sm transition-transform duration-300 group-hover:scale-[1.03]"
                    style={{
