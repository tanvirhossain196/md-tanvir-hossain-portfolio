...
export default function ContactForm() {
  ...
  const fieldClass =
    "w-full bg-transparent border border-line rounded-md px-4 py-3 text-sm text-paper placeholder:text-paperdim/50 focus:outline-none focus:border-[#64FFDA] transition-colors";
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <button
        type="submit"
        className="group relative overflow-hidden font-mono text-sm tracking-wide uppercase border-2 border-[#F5F1E8]/60 bg-transparent text-paper font-semibold rounded-md px-8 py-3.5 transition-all duration-500 ease-[cubic-bezier(0.65,0,0.35,1)] hover:-translate-y-0.5 hover:border-[#64FFDA] hover:text-[#64FFDA] hover:shadow-[0_20px_45px_-15px_rgba(100,255,218,0.35)]"
      >
